...
Page({
  ...
  getAllTwoLevelMenu() {
    ...
    app.globalData.ajax("/getAllTwoLevelMenuByMenuId", "get", {
      ...
      if (res.code === 1) {
        ...
        This.data.tableData.push(...result.result)
  ...
  slideButtonTap(e) {
    ...
    if (e.currentTarget.dataset.id) {
      ...
      this.setData({ isShow: 'block', isOp: 1, projectTitle: "修改工程", name: name, editId: e.currentTarget.dataset.id });
    } else {
      this.setData({ isShow: 'block', isOp: 1, projectTitle: "添加工程" });
    }
  },
